...
* **Level 3 — Velocity Check:** A massive horizontal chasm spans 6 empty cells. The player places a Straight Ramp below the launchpad to convert the drop into horizontal momentum, then a Speed Booster at the base to launch the marble across the gap to the goal. Grid: 9×4×4.
